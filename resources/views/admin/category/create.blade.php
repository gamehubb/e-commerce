...
@section ('content')
    ...
    <div class="row justify-content-center">
        ...
        @endif
            <form action="/auth/category/create" method="POST" enctype="multipart/form-data">@csrf
                <div class="card mb-6">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="category_name" class="form-control @error('category_name') is-invalid @enderror" id="" aria-describedby="" placeholder="Enter Name Of Category">
                            @error('category_name')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="category_description" id="" cols="30" rows="3" class="form-control @error ('category_description') is-invalid @enderror"></textarea>
